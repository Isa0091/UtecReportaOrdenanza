...
public class ListadoDordenanza extends AppCompatActivity implements AdapterReport.InterfaceReportes {
    ...
    private  String UrlReportesEdificio = "http://192.168.1.157:80/UtecReportaOrdenanza/Webservices/ReportesProcesoOrdenanza.php?iduserordenanza=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listado__dordenanza);
    ...
    private void CargarDatos(){
        ...
        progressDialog.show();
        String urldata= UrlReportesEdificio + usuario;
    ...
    private void configurarRecycler(List<ItemReport> itemReportList) {
        adapter = new AdapterReport(itemReportList,getApplicationContext(), ListadoDordenanza.this);
    ...
    public void CambiarEstado(int idresporte, int idestadoactual) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ListadoDordenanza.this);
